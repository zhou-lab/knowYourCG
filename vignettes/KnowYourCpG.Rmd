...
``` {r load-dependencies, eval=FALSE, echo=FALSE}
...
# TODO: use temp dir instead in vignette
# TODO: can we make this more presentable?
```
...
``` {r, eval=FALSE, echo=FALSE}
# TODO: break this into another section... different testing scenarios
# TODO: also break up the code with explanations so it looks less messy in between

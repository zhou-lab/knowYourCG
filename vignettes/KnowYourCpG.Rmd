...
``` {r create-continuous-data, echo=FALSE}
...
```{r run-test-few, eval=FALSE}
## Case 1
results = list()

results[[1]] = testEnrichmentAll(querySet=querySetCont, databaseSets=databaseSetsCont, platform="MM285", verbose=TRUE)

## Case 2
results[[2]] = testEnrichmentAll(querySet=querySetCont, databaseSets=databaseSet, platform="MM285", verbose=TRUE)

## Case 3
results[[3]] = testEnrichmentAll(querySet=querySet, databaseSets=databaseSetsCont, platform="MM285", verbose=TRUE)


## Case 4
results[[4]] = testEnrichmentAll(querySet=querySet, databaseSets=databaseSet, platform="MM285", verbose=TRUE)
...
```{r plot-volcano, fig.width=7, fig.height=4, echo=FALSE}

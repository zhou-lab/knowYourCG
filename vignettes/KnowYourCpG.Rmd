...
databaseSets = databaseSetGet(databaseSetNames, dev=TRUE)
...
allresults = testEnrichmentAll(querySet=querySet, databaseSets=databaseSets, verbose=FALSE)
print(allresults)
```
...
results = testEnrichmentAll(querySet=querySet, databaseSets=CpGDensitydatabaseSet, platform="MM285")
print(results)
```

``` {r run-test-other2, echo=TRUE, eval=TRUE}
results = testEnrichmentAll(querySet=querySet, databaseSets=Dist2TSSdatabaseSet, platform="MM285")
print(results)
```

``` {r run-test-other3, echo=TRUE, eval=TRUE}
results = testEnrichmentAll(querySet=CpGDensitydatabaseSet$CpGDesity50, databaseSets=Dist2TSSdatabaseSet, platform="MM285")
print(results)
```

...
IDs. This tool automates the hypothesis testing by asking whether a set of
...
the categorical groups and overlapping genes (genes associated with CpGs in the query).
...
Additional methods are available for visualizing enrichment results:
...
Gene enrichment testing can be included with the enrichment testing of default or
...
In this case gene enrichment and other database set enrichments are included together:

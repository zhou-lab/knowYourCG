...
library(knowYourCG)
library(sesameData)
sesameDataCache(data_titles=c("KYCG.MM285.tissueSignature.20211211","genomeInfo.mm10","probeIDSignature","genomeInfo.hg38"))
```
...
When accessing data for the first time, caching can be performed to enable
faster access in future testing. More information on available database sets is
discussed below.

```{r ky2, message=FALSE}
sesameDataCache("KYCG.MM285.designGroup.20210210")

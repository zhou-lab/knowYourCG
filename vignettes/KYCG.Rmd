...
(e.g., CpGs located at specific tissue-specific transcription factors) 
...
such as CpGs associated with particular chromatin states, technical artifacts, 
gene association andgene expression correlation, transcription factor 
...
dbs <- KYCG_loadDBs(
    "~/Downloads/KYCG_knowledgebase_EPICv2/hg38/CGI.20220904.gz"
    )
```

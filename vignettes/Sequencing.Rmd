...
The sequencing workflow shown here is superseded by the
[kycg](https://github.com/zhou-lab/kycg) command-line tool, which does the same
analysis natively over YAME `.cg` stores and fetches its own knowledgebases.

...
If you have a BED-formatted data, you can pack it to YAME-"b" format using the
...
Then we simply run [`yame summary`](https://zhou-lab.github.io/YAME/docs/summarize.html) with
`-m` feature file for enrichment testing. We have provided comprehensive
enrichment feature files, and you can download them from the KYCG github page
[mm10](https://github.com/zhou-lab/KYCGKB_mm10)/[hg38](https://github.com/zhou-lab/KYCGKB_hg38). You
can also create your own feature file with [`yame pack`](https://zhou-lab.github.io/YAME/docs/pack_unpack.html).
...
summary`](https://zhou-lab.github.io/YAME/docs/summarize.html) page. Basically, a higher
...
R package provides the testEnrichmentFisherN function, which is also provided
